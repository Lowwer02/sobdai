...
export const HOMEPAGE_DEFAULTS: HomepageSettings = {
  ...
  hero: {
    ...
    subtitle: 'ฝึกทำแนวข้อสอบราชการออนไลน์ทีละข้อ พร้อมสรุปและเฉลยละเอียด วิเคราะห์จุดอ่อน และเตรียมสอบราชการได้อย่างมั่นใจ',
  ...
  features: [
    { icon: 'exam', title: 'ข้อสอบตามหน่วยงานและตำแหน่ง', description: 'คลังแนวข้อสอบราชการตรงตามสังกัดและสายงาน คัดสรรตรงตามระเบียบการสอบจริง' },
    { icon: 'hint', title: 'คำใบ้ทุกข้อ', description: 'กดดูคำใบ้ได้เมื่อต้องการ ช่วยให้คิดเป็นระบบก่อนดูเฉลย' },
    { icon: 'explain', title: 'แนวข้อสอบราชการพร้อมเฉลย', description: 'ทุกข้อมีคำอธิบายเหตุผลและข้อกฎหมาย ไม่ใช่แค่บอกว่าข้อไหนถูก' },
    { icon: 'lock', title: 'บันทึกและทบทวน', description: 'เลือกบันทึกข้อที่น่าสนใจ และทบทวนข้อที่ตอบผิดได้ตลอดเวลา' },
  ],
  howto: [
    { num: '01', title: 'เลือกข้อสอบตามหน่วยงานและตำแหน่ง', desc: 'ค้นหาตามสังกัดและสายงานที่เปิดสอบ ตรงตามเกณฑ์จริง' },
