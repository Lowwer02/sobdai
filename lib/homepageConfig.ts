...
export const HOMEPAGE_DEFAULTS: HomepageSettings = {
  ...
  package_explorer: {
    ...
    subtitle: 'แต่ละชุดข้อสอบมาพร้อมแบบฝึกหัด เฉลยละเอียด และระบบติดตามความพร้อมรายบุคคล',
  ...
  howto: [
    { num: '01', title: 'เลือกข้อสอบตามหน่วยงานและตำแหน่ง', desc: 'ค้นหาชุดข้อสอบที่ตรงกับหน่วยงานและสายงานที่เปิดรับสมัคร เพื่อฝึกฝนเนื้อหาที่ตรงเป้าหมาย' },
    { num: '02', title: 'ฝึกทำเหมือนสอบจริง', desc: 'ฝึกทำข้อสอบทีละข้อ พร้อมระบบจับเวลา คำใบ้ช่วยคิด และแนวข้อสอบราชการพร้อมเฉลยละเอียด' },
    { num: '03', title: 'วิเคราะห์และพัฒนา', desc: 'ดูรายงานผลความแม่นยำ วิเคราะห์จุดอ่อนรายหมวดวิชา และทบทวนข้อสอบที่ตอบผิดเพื่อปิดจุดบกพร่อง' },
  ],
  support: {
    enabled: true,
