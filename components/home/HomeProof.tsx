...
export default function HomeProof() {
  const pillars = [
    ...
    },
    {
      ...
      desc: 'มีคำอธิบายเหตุผล และในข้อที่เกี่ยวข้องมีหลักหรือข้อกฎหมายประกอบ ช่วยให้เข้าใจคำตอบและตัวเลือกต่าง ๆ',
    },
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      desc: 'บันทึกข้อที่น่าสนใจ ทบทวนข้อที่ตอบผิด และกลับมาทำชุดข้อสอบใหม่ได้',
    },
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
