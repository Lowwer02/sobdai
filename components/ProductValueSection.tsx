...
export default function ProductValueSection() {
  const storyPoints = [
    {
      num: '01',
      title: 'เข้าใจเหตุผลและหลักการ',
      desc: 'เฉลยอธิบายที่มาของคำตอบ พร้อมวิเคราะห์เหตุผลของตัวเลือกต่าง ๆ ช่วยให้จำหลักการได้แม่นยำขึ้น',
    },
    {
      num: '02',
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            การท่องจำเฉลยทำให้ลืมง่ายเมื่อเจอข้อสอบพลิกแพลง Sobdai จึงออกแบบให้ข้อสอบเชื่อมโยงกับเหตุผล เพื่อให้คุณเข้าใจหลักการอย่างแท้จริง
          </p>
