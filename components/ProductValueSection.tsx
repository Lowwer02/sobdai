...
export default function ProductValueSection() {
  const storyPoints = [
    {
      num: '01',
      title: 'เข้าใจเหตุผลและหลักการทุกข้อ',
      desc: 'เฉลยละเอียดอธิบายที่มาของคำตอบ พร้อมวิเคราะห์ว่าตัวเลือกอื่นผิดเพราะอะไร ช่วยให้จำหลักการได้แม่นยำขึ้น',
    },
    {
      num: '02',
      title: 'ชี้เป้าจุดอ่อนรายหัวข้อ',
      desc: 'สรุปผลคะแนนแยกตาม พ.ร.บ. และเนื้อหาวิชาหลังทำชุดข้อสอบ ชี้ชัดว่าจุดไหนเข้าใจแล้ว และจุดไหนยังต้องทบทวน',
    },
    {
      num: '03',
      title: 'แนะนำแนวทางการฝึกฝนถัดไป',
      desc: 'ระบบช่วยเชื่อมโยงผลการสอบไปยังสรุปเนื้อหาและชุดข้อสอบที่ตรงกับจุดอ่อน เพื่อพัฒนาคะแนนอย่างมีทิศทาง',
    },
  ]
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            การท่องจำเฉลยทำให้ลืมง่ายเมื่อเจอข้อสอบพลิกแพลง Sobdai จึงออกแบบให้ทุกข้อเชื่อมโยงกับเหตุผล เพื่อให้คุณเข้าใจหลักการอย่างแท้จริง
          </p>
