  ...
  const steps = [
    {
      ...
      desc: 'ค้นหาตามสังกัดและสายงานที่เปิดสอบ เข้าถึงแนวข้อสอบราชการตรงประเด็น',
    },
    {
      num: '02',
      title: 'ฝึกทำเหมือนสอบจริง',
      desc: 'ฝึกทำทีละข้อ มีระบบจับเวลา คำใบ้ช่วยคิด และแนวข้อสอบราชการพร้อมเฉลยละเอียดทันที',
    },
    {
      num: '03',
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '44px' }}>
        ...
        >
          กระบวนการฝึกทำข้อสอบราชการที่ออกแบบให้คุณเข้าใจลึกซึ้งและพร้อมที่สุดในวันสอบจริง
        </p>
      </div>
