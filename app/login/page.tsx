    ...
    <div className="min-h-screen bg-[#0F0B07] text-[#F5E9D6] flex flex-col items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full text-center mb-8">
        ...
        {banned ? (
          <div
            role="alert"
            className="mb-6 rounded-xl border border-red-500/30 bg-red-500/10 px-5 py-4 text-left"
          >
            <h1 className="text-xl font-bold text-red-300 mb-1">บัญชีของคุณถูกระงับ</h1>
            <p className="text-sm text-red-200/80">กรุณาติดต่อผู้ดูแลระบบ</p>
          </div>
        ) : (
          <>
