        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#1A140E] border border-[rgba(212,175,55,0.15)] rounded-2xl p-6 shadow-xl space-y-5">
            ...
            <div className="space-y-2">
              ...
              {/* Homepage ordering — only meaningful when featured_homepage is
                  checked. Shown inline; the field is always rendered so the
                  value persists on save even if an admin toggles featured off
                  and back on later. */}
              <div className="space-y-1.5">
                ...
                <input
                  type="number"
                  name="homepage_order"
                  defaultValue={pkg.homepage_order ?? 0}
